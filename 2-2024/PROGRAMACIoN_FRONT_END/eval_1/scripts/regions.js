const regionCityMap = {
    ...
    "Ñuble": ["Cobquecura", "Coelemu", "Ninhue", "Portezuelo", "Quirihue", "Ránquil", "Treguaco", "Bulnes", "Chillán", "Chillán Viejo", "El Carmen", "Pemuco", "Pinto", "Quillón", "San Ignacio", "Yungay", "Quirihue", "San Carlos", "San Fabián", "San Nicolás"],
...
function updateCities() {
    ...
    citySelect.innerHTML = '<option value="">Seleccione una comuna</option>';

    if (selectedRegion && regionCityMap[selectedRegion]) {
        const cities = regionCityMap[selectedRegion];
        cities.forEach(city => {
